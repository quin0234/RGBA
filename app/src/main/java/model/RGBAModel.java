...
public class RGBAModel extends Observable {
    ...
    public void asBlack()   { this.setRGB( MIN_RGB, MIN_RGB, MIN_RGB, MAX_ALPHA ); }
    public void asBlue()    { this.setRGB( MIN_RGB, MIN_RGB, MAX_RGB, MAX_ALPHA ); }
    public void asCyan()    { this.setRGB( MIN_RGB, MAX_RGB, MAX_RGB, MAX_ALPHA ); }
    public void asGreen()   { this.setRGB( MIN_RGB, MAX_RGB, MIN_RGB, MAX_ALPHA ); }
    public void asMagenta() { this.setRGB( MAX_RGB, MIN_RGB, MAX_RGB, MAX_ALPHA ); }
    public void asRed()     { this.setRGB( MAX_RGB, MIN_RGB, MIN_RGB, MAX_ALPHA ); }
    public void asWhite()   { this.setRGB( MAX_RGB, MAX_RGB, MAX_RGB, MAX_ALPHA ); }
    public void asYellow()  { this.setRGB( MAX_RGB, MAX_RGB, MIN_RGB, MAX_ALPHA ); }
    ...
    public void setRGB( Integer red, Integer green, Integer blue, Integer alpha ) {
        this.red   = red;
        this.green = green;
        this.blue  = blue;
        this.alpha = alpha;
