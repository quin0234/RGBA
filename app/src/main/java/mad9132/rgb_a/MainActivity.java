...
import static mad9132.rgb_a.R.string.alphaProgress;
import static mad9132.rgb_a.R.string.blueProgress;
import static mad9132.rgb_a.R.string.greenProgress;
import static mad9132.rgb_a.R.string.redProgress;
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        switch ( seekBar.getId() ) {
            case R.id.redSB:
                ...
                mRedTV.setText( getResources().getString(redProgress, progress).toUpperCase() );
                break;

            case R.id.greenSB:
                mModel.setGreen( mGreenSB.getProgress() );
                mGreenTV.setText( getResources().getString(greenProgress, progress).toUpperCase() );
                break;

            case R.id.blueSB:
                mModel.setBlue( mBlueSB.getProgress() );
                mBlueTV.setText( getResources().getString(blueProgress, progress).toUpperCase() );
                break;

            case R.id.alphaSB:
                mModel.setAlpha( mAlphaSB.getProgress() );
                mAlphaTV.setText( getResources().getString(alphaProgress, progress).toUpperCase() );
                break;
        }
    }
